...
function ViewProduct(props) {
    ...
    const handleShow = (_id, productid, name, category, price, quantity, total, date) => {
        setShow(true);
        setid(_id);
    ...
    function update() {
        const newTime = {
            _id, productid, name, category, price, quantity, total, date
        }

        axios.put("http://localhost:8070/product/update/" + _id, newTime).then(() => {
    ...
    return (
        <div>
            <Sidemenu />
            <div style={{ paddingLeft: "10vh", color: 'white', paddingTop: '3vh' }}>
                <div style={{ paddingLeft: '170vh'}}>

                    <Button>Logout</Button>
                </div>
            </div>
            <div style={{ paddingLeft: '28vh', paddingRight: '7vh', paddingTop: '3vh', paddingBottom: '4vh' }}>
                <Card border="secondary">
                    <div style={{ paddingBottom: "8vh", paddingTop: "5vh", paddingLeft: "8vh", paddingRight: "5vh" }}>
                        <div style={{ paddingBottom: "5vh", paddingTop: "5vh", paddingLeft: "5vh", paddingRight: "5vh" }}>
                            <h1 style={{ paddingLeft: "40%", paddingBottom: "5vh" }}>Product List</h1>
                                        ...
                                        map((Order) => {
                                            ...
                                            return (
                                                <tr key={Order._id}>
                                                    ...
                                                    <td>{Order.date}</td>
                                                    <td>
                                                        <Button variant="outline-success" onClick={() => handleShow(Order._id, Order.productid, Order.name, Order.category, Order.price, Order.quantity, Order.total, Order.date)} ><FaPencilAlt /></Button>
                                                    </td>
                    ...
                    <Modal.Body>
                        <Form >
                            <div >
                                ...
                                <Form.Control placeholder="productid"
                                    value={productid}
